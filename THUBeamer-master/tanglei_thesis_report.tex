...
\title{TCP/NC的一种补偿重传机制}
%\author{唐磊}
\author[董泽锋]{~\vskip 20pt学~~~~~~生：董~~~~~泽~~~~~锋\vskip 5pt 指导教师：陈~~庆~~春~~教授}
\institute[西南交通大学~信息学院]{\small \vskip 68pt信息编码与传输重点实验室 }
%\date{2015-06-07}
\date{\small \vskip -17pt二〇一七年四月}
%\date{\today}
...
\begin{figure}[htbp]
  \begin{center}
	\includegraphics[width=0.14\linewidth]{swjtu_logo.png}
  \end{center}
\end{figure}
%\beign{picture}(1,1)
